...
-- Make line numbers & relative line numbers default
vim.wo.number = true
...
local on_attach = function(_, bufnr)
  ...
  nmap('<leader>qa', vim.lsp.buf.code_action, '[C]ode [A]ction')
...
local servers = { 'clangd', 'pyright', 'sumneko_lua', 'html' }
